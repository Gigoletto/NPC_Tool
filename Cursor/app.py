...
def _theme_override_css() -> str:
    ...
    return (
        ...
        "[data-testid='stSlider'] [class*='react-aria-SliderTrack'] > :first-child{"
        "filter:none!important;"
        "}"
...
def _inject_theme_into_parent() -> None:
    ...
    script = (
        ...
        "return /#ff4b4b|#f63366|#ff2b2b/i.test(s);"
        "}"
        "function paintTracks(){"
        "doc.querySelectorAll('[data-testid=stSlider]').forEach(function(root){"
        "var track=root.querySelector('.react-aria-SliderTrack,[class*=react-aria-SliderTrack]');"
        "if(!track||!track.children.length)return;"
        "var bar=track.children[0];"
        "if(bar.querySelector&&bar.querySelector('[data-testid=stSliderThumbValue]'))return;"
        "var thumb=track.querySelector('[role=slider]');"
        "if(!thumb)return;"
        ...
        "}"
        "function paint(){"
        "doc.querySelectorAll('[data-testid=stCheckbox],[data-testid=stRadio],.stCheckbox,.stRadio,[data-testid=stSlider],[data-testid=stButtonGroup]').forEach(function(root){"
